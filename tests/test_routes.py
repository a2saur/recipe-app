...
def init_tags():
    ...
    # initialize the tags
    if count == 0:
        # tags = ['funny','inspiring', 'true-story', 'heartwarming', 'friendship'] # rewrite this list 
        for t in tags:
...
def test_post(test_client,init_database): # rewrite this test
    """
...
"""
def test_like_smile(test_client,init_database): # rewrite this test
    """
    GIVEN a Flask application configured for testing , after user logs-in,
