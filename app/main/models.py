...
class Recipe(db.Model):
    ...
    activeEstimatedHrs : sqlo.Mapped[int] = sqlo.mapped_column(sqla.Integer, default=0)
    activeEstimatedMins : sqlo.Mapped[int] = sqlo.mapped_column(sqla.Integer, default=0)
    overallEstimatedHrs : sqlo.Mapped[int] = sqlo.mapped_column(sqla.Integer, default=0)
    overallEstimatedMins : sqlo.Mapped[int] = sqlo.mapped_column(sqla.Integer, default=0)
