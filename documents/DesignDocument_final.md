...
| :---- | :---- | :---- | :---- |
| Revision 1 | 2026-2-10 | Initial draft | 1.0 |
| Revision 2 | 2026-2-12 | Updated diagrams | 1.0 |
| Final Draft | 2026-2-20 | Changed to final draft | 2.0 |
...
**Certification:** Stores the name of certified user certifications and the date received.
...
| :---- | :---- | :---- | :---- |
| 1. | GET, POST | /index | Displays the main page with a list of recipe posts. Includes a filter and sorter feature.   |
...
| 3. | GET, POST | /user/profile/certify | Renders the page with a form to become certified |
| 4. | GET, POST | /user/profile/business | Renders a form that allows the user to input their business information |
| 5. | GET, POST | /user/profile/business/edit | Renders a form that allows the user to edit their business information. |
...
| 11. | GET, POST | /user/profile/edit_certification | Renders a form that allows a user to edit their certification information |
